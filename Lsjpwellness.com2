export default function LSJPWellnessSite() {
  return (
    <main className="min-h-screen bg-white text-gray-800 p-6">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-2">L.S.J.P.</h1>
        <p className="text-xl italic text-gray-600">Global wellness sourcing</p>
      </header>
...
function ProductCard({ title, image, description, origin, priceRange }) {
  return (
    <div className="border rounded-2xl shadow-md p-4">
      ...
      <p className="text-sm text-gray-700 font-medium">Price: {priceRange}</p>
    </div>
  );
}
